const threatDot = {
  ...
  Elevated: "bg-cyan shadow-[0_0_24px_rgba(125,226,209,0.7)]",
};
...
export function IndiaBankMapPanel({ bankIntel }) {
  return (
    <div className="panel p-5">
      ...
      <div className="relative overflow-hidden rounded-[28px] border border-line/70 bg-[radial-gradient(circle_at_top,rgba(89,167,255,0.16),transparent_38%),linear-gradient(180deg,rgba(3,11,25,0.5),rgba(3,11,25,0.9))] p-4">
        <svg viewBox="0 0 320 420" className="mx-auto h-[440px] w-full max-w-[420px]">
          <path
            ...
            fill="rgba(125,226,209,0.08)"
            stroke="rgba(125,226,209,0.25)"
            strokeWidth="2"
          />
          <path
            d="M245 344l19 17 7 26-19 14-18-19 11-38z"
            fill="rgba(125,226,209,0.06)"
            stroke="rgba(125,226,209,0.18)"
            strokeWidth="2"
          />
        </svg>
        ...
        <div className="pointer-events-none absolute inset-0">
          {bankIntel.states.map((entry) => (
            ...
            >
              ...
              <div className="mt-2 -translate-x-1/2 rounded-2xl border border-line/70 bg-black/75 px-3 py-2 text-[11px] leading-5 text-slate-100 backdrop-blur-xl">
      ...
      <div className="mt-4 flex flex-wrap gap-3 text-xs uppercase tracking-[0.18em] text-slate-400">
        ...
        <span className="rounded-full border border-cyan/30 px-3 py-1 text-cyan">Elevated anomaly</span>
      </div>
    </div>
  );
}
